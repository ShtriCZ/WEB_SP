...
<div class="login">
    ...
    if(isset($_POST['role'])){
        ...
        if($role=="Změnit roli autora"){
            //Výběr dat z autorů
            $prikaz = "SELECT * FROM autori WHERE uzjmeno='$id'";
    ...
    VALUES ('$jmeno', '$prijmeni', '$email', '$uzjmeno', '$heslo')";
            ...
            $sql = " DELETE FROM `autori` WHERE uzjmeno='$id'";
            if ($conn->query($sql) === TRUE) {
        ...
        //Pokud se má měnit role recenzenta na autora
            ...
            $prikaz = "SELECT * FROM recenzenti WHERE uzjmeno='$id'";
            $resul = $conn->query($prikaz);
    ...
    VALUES ('$jmeno', '$prijmeni', '$email', '$uzjmeno', '$heslo')";
            ...
            $sql = " DELETE FROM `recenzenti` WHERE uzjmeno='$id'";
            if ($conn->query($sql) === TRUE) {
                echo "Vytvořen nový záznam:";
            } else {
                echo "Chyba: " . $sql . "<br>" . $conn->error;
